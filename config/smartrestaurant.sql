...
--
-- Host: localhost
-- Generation Time: May 27, 2019 at 09:12 PM
...
CREATE TRIGGER `salesTrigger` BEFORE UPDATE ON `sales` FOR EACH ROW BEGIN
    INSERT INTO salesTrails (id, shopId, invoice_number, cashier, waiter, amount, discount, balance, ord_type, period, nhil, fund, vat, status, tid,  hall,  kitchen_status,approved_by, created_by, created_at, updated_by, updated_at)
    VALUES (OLD.id, OLD.shopId, OLD.invoice_number,  OLD.cashier, OLD.waiter, OLD.amount,  OLD.discount, OLD.balance, OLD.ord_type, OLD.period, OLD. nhil, OLD.fund, OLD.vat, OLD.status, OLD.tid, OLD.hall, OLD.kitchen_status, OLD.approved_by, OLD.created_by,  OLD.created_at,  OLD.updated_by,  OLD.updated_at );
END
$$
DELIMITER ;
...
(1, 1, 'Akinniyi Bolade', NULL, 'beedyboy', '$2y$10$uxr1QgkRid6i5Ka2d7rXY.nW.FMj0W2/touepym/nXj9vfG4cMrqe', 'Active', '2925cc0a08816c30447a201ca6099e28', NULL, NULL, NULL, 'Super Admin', NULL, '2019-04-05 12:15:11', '2019-04-05 12:15:11'),
(2, 1, 'Sydney Ankrah', NULL, 'sydney', '$2y$10$DQIfPoq12HUp3ItVb.UcFOzxXVxrw5IBDxryPBhuAZjlbJlt9/5vG', 'Active', 'bd01bac39ac5cb95bdd50e0b05ec27c0', NULL, NULL, NULL, 'Supervisor', NULL, '2019-04-05 13:06:28', '2019-05-08 02:15:48'),
(3, 1, 'Joseph Kayode', NULL, 'kayode', '$2y$10$G4N84yfBkYByY5LNAzWPZO2tGr8V8p8JBCjX4m06LtkwQwQcXIDz.', 'Active', '460dff6d7dac72108b655304a0d58397', NULL, NULL, NULL, 'Waiter', NULL, '2019-04-30 10:22:51', '15-05-2019 14:46:41pm'),
(4, 1, 'Aluko Oluwasegun', NULL, 'segzy', '$2y$10$zgNnTOWEn1IZAow50dlpv.wb4zk3cHq64MW0w3qIWIeiXOq5wRaKe', 'Active', 'cace19c018fbbe61d16d34a0465b536d', NULL, NULL, NULL, 'Cashier', NULL, '2019-05-05 17:04:41', '18-05-2019 08:51:57am'),
(6, 1, 'Akinniyi Boluwatife', NULL, 'sage', '$2y$10$QmO6J0iMLt4twRNGnwMzDeMPt2CpfXJ8qcNmo/o1NAfbTpDZwn1m2', 'Active', 'd4788b5fb40cf0e8d8cacc812aa99157', NULL, NULL, NULL, 'Admin', NULL, '2019-05-06 11:34:52', '2019-05-06 11:34:52'),
(9, 1, 'Odeyemi Tolulope', NULL, 'tolu', '$2y$10$Si1.yMdOuYYAdD/l01h5wuWox5VD2lxCuU//Z0KRxRbOXF8BLTXxa', 'Deleted', NULL, NULL, NULL, NULL, 'Admin', NULL, '2019-05-06 12:06:06', '15-05-2019 14:46:56pm'),
(10, 2, 'Akinniyi Bolade', NULL, 'luckie', '$2y$10$Ezdl8W.Fzj7fQ7T4pao2KO0pmB7xv9f6MqmPoDUScIHk2vI/wVskq', 'Active', '2a740e86437ad99687d36bfe83a1d141', NULL, NULL, NULL, 'Super Admin', NULL, '2019-05-06 15:07:40', '2019-05-06 15:07:40'),
(11, 3, 'akinniyi bolade', NULL, 'abraham', '$2y$10$cvWBL4imuAGH.fnLtfw7QunD3VM6lskBkzXhsN1EDBJcO0Qt77R1K', 'Active', '595548330b22c5adff09533aba31b135', NULL, NULL, NULL, 'Super Admin', NULL, '2019-05-08 02:24:10', '2019-05-08 02:24:10'),
(13, 1, 'Tife', NULL, 'tife', '$2y$10$AgVt6v0xgsbv3ApZwvgSQuvpRmzc3RpPNcUt0og4Zzjr/iJ9O9Wdq', 'Active', '98dcf4fb771765f3597c2f30482a62e2', NULL, NULL, NULL, 'Waiter', NULL, '17-05-2019 21:56:15pm', '18-05-2019 22:00:06pm');
